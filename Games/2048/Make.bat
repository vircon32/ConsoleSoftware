...
echo --------------------------
png2vircon Texture2048.png -o obj\Texture2048.vtex || goto :failed
...
wav2vircon sounds\SoundTitleTiles.wav    -o obj\SoundTitleTiles.vsnd    || goto :failed
...
wav2vircon sounds\SoundMoveBoard.wav     -o obj\SoundMoveBoard.vsnd     || goto :failed
wav2vircon sounds\SoundTileCollision.wav -o obj\SoundTileCollision.vsnd || goto :failed
wav2vircon sounds\SoundTileAdded.wav     -o obj\SoundTileAdded.vsnd     || goto :failed
wav2vircon sounds\SoundNewHighest.wav    -o obj\SoundNewHighest.vsnd    || goto :failed
...
echo Pack the ROM
echo --------------------------
packrom 2048.xml -o bin\2048.v32 || goto :failed
goto :succeeded
